...
class TestGroupByAllele(unittest.TestCase):
    ...
    def setUp(self):
        self.header = ['chrom', 'pos', 'ref', 'alt', 'measureset_type', 'measureset_id',    'rcv', 'allele_id', 'symbol', 'clnhgvs',           'hgvs_p',                               'molecular_consequence', 'clnsig', 'pathogenic', 'benign', 'conflicted',                      'review_status',          'gold_stars',                                                                'all_submitters',                    'all_traits',                                                                                                   'all_pmids', 'inheritance_modes', 'age_of_onset', 'prevalence', 'disease_mechanism', 'clnorigin', 'xrefs' ]
    ...
    def test_group_alleles(self):
        ...
        self.assertEqual(combined_data2['clnsig'], "Uncertain significance;Likely benign")
    ...
    def test_group_by_allele(self):
        ...
        for i, output_row in enumerate(outfile.getvalue().split('\n')):
            if i == 0:
                ...
                self.assertEqual(combined_data['clnsig'], "Uncertain significance;Likely benign")
